...
module.exports = class extends BotEvent {
    ...
    const fetched = await db.get(`log-channel_${newMember.guild.id}.channelid`);
    const fetch = await db.get(`guildMemberUpdate_${newMember.guild.id}.value`);
