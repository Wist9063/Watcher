    ...
    if (fetch === true) {
      ...
      if (voice1 == 'None') {
        const embed = new MessageEmbed()
          ...
          .setDescription(`${newState.member.user.tag} (ID:${newState.member.user.id}) joined voice channel **${newState.channel.name}**.`)
          .setTimestamp();
        ...
        const embed = new MessageEmbed()
          ...
          .setTitle('Voice State Update')
          .setURL('https://discord.gg/83SAWkh')
          .setDescription(`${newState.member.user.tag} (ID:${newState.member.user.id}) left voice channel **${voice1}**.`)
          .setTimestamp();
        return logChannel.send(embed);
        ...
        const embed = new MessageEmbed()
          ...
          .setTitle('Voice State Update')
          .setURL('https://discord.gg/83SAWkh')
          .setDescription(`${newState.member.user.tag} (ID:${newState.member.user.id}) moved from **${voice1}** -> **${newState.channel.name}**.`)
          .setTimestamp();
        return logChannel.send(embed);
      }
    } else {
