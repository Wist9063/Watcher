...
class PermissionLevel {
  ...
  fetch(user, message) {
    ...
    if (config.helpers.includes(user.id)) return [9, '<a:verifiedtech:742101827650322443> Development Team'];
    if (config.admins.includes(user.id)) return [8, '<a:verifiedtech:742101827650322443> Global Admin'];
    if (config.mods.includes(user.id)) return [7, '<a:verifiedtech:742101827650322443> Global Mod'];
