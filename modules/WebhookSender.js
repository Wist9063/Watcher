...
module.exports = pkg => { 
  ...
  setTimeout( function() {
    new WebhookClient({id: pkg.webhook.id, token: pkg.webhook.token}).send({embeds: [pkg.embed], username: 'Watcher', avatar: 'https://cdn.discordapp.com/avatars/505571539333152781/cbf64e07e3991abb9b8847627dd2a2ab.webp?size=2048'})
      .catch( async e => {
        await mongo.connect();
