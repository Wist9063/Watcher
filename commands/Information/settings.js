...
module.exports = class extends Command {
  ...
  async execute(message) {
    ...
    return await message.reply({ content: `${check} **Displaying module information for \`${content ? this.client.guilds.resolve(content).name : message.guild.name}\`**.`, embeds: [embed], allowedMentions: { repliedUser: false }});
  }
};